...
disp('-------------------------')
disp('Caculate the Lagrangian of the system: ')
% T =  % this is the total kinetic energy of the system 
% T = simplify(T, 'Steps',50)
% V = % this is the total potential energy of the system
...
%% 
% Calculate the matrix D as follows. Compare the result with the Mass matrix 
% above. What do you conclude? 

% D0 = jacobian(T, dq).';
% D = jacobian(D0, dq)
%%
% Save your matrices and simulate
if ~exist('dynamics', 'dir')
    mkdir('dynamics')
end
